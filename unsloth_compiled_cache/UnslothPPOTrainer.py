...
from trl.trainer.ppo_trainer import (Accelerator, BaseImageProcessor, CallbackHandler, DEFAULT_CALLBACKS, DEFAULT_PROGRESS_CALLBACK, DataCollatorWithPadding, DataLoader, Dataset, Dict, ExportableState, F, FeatureExtractionMixin, GenerationConfig, INVALID_LOGPROB, List, OnlineTrainerState, Optional, PPOConfig, PPOTrainer, PolicyAndValueWrapper, PreTrainedTokenizerBase, PrinterCallback, ProcessorMixin, Trainer, TrainerCallback, TrainerControl, Tuple, Union, batch_generation, broadcast, defaultdict, disable_dropout_in_model, exact_div, first_true_indices, forward, gather_object, gc, generate_model_card, get_reporting_integration_callbacks, get_reward, is_wandb_available, masked_mean, masked_whiten, math, nn, np, os, pd, prepare_deepspeed, print_rich_table, textwrap, time, torch, truncate_response, unwrap_model_for_generation, Accelerator, BaseImageProcessor, CallbackHandler, DEFAULT_CALLBACKS, DEFAULT_PROGRESS_CALLBACK, DataCollatorWithPadding, DataLoader, Dataset, Dict, ExportableState, F, FeatureExtractionMixin, List, OnlineTrainerState, Optional, PPOConfig, PolicyAndValueWrapper, PreTrainedTokenizerBase, PrinterCallback, ProcessorMixin, Trainer, TrainerCallback, TrainerControl, Tuple, Union, broadcast, disable_dropout_in_model, exact_div, get_reporting_integration_callbacks, math, nn, os, prepare_deepspeed, time, torch)

...
from trl.trainer.dpo_trainer import (Any, AutoModelForCausalLM, BaseImageProcessor, Callable, DPOConfig, DPOTrainer, DataCollator, DataLoader, Dataset, Dict, EvalLoopOutput, F, FDivergenceConstants, FDivergenceType, FeatureExtractionMixin, List, Literal, MODEL_FOR_VISION_2_SEQ_MAPPING_NAMES, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedModelWrapper, PreTrainedTokenizerBase, PreferenceCollator, ProcessorMixin, RunningMoments, SyncRefModelCallback, Trainer, TrainerCallback, Tuple, Union, _deprecate_arguments, amp, cap_exp, contextmanager, create_reference_model, dataclass, deepcopy, defaultdict, deprecate_kwarg, disable_dropout_in_model, generate_model_card, inspect, is_peft_available, is_wandb_available, maybe_apply_chat_template, maybe_extract_prompt, nn, nullcontext, os, pad, pad_to_length, peft_module_casting_to_bf16, prepare_model_for_kbit_training, random, textwrap, torch, tqdm, warnings, AutoModelForCausalLM, BaseImageProcessor, Callable, DPOConfig, DPOTrainer, DataCollator, Dataset, Dict, EvalLoopOutput, F, FDivergenceConstants, FeatureExtractionMixin, List, MODEL_FOR_VISION_2_SEQ_MAPPING_NAMES, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, PreferenceCollator, ProcessorMixin, RunningMoments, SyncRefModelCallback, Trainer, TrainerCallback, Tuple, Union, amp, create_reference_model, defaultdict, deprecate_kwarg, disable_dropout_in_model, inspect, is_peft_available, is_wandb_available, maybe_apply_chat_template, maybe_extract_prompt, nn, os, pad, peft_module_casting_to_bf16, prepare_model_for_kbit_training, torch, warnings)

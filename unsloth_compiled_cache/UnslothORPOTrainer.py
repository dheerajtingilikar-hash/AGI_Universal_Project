...
from trl.trainer.orpo_trainer import (Any, AutoModelForCausalLM, BaseImageProcessor, Callable, DPODataCollatorWithPadding, DataCollator, DataLoader, Dataset, Dict, EvalLoopOutput, F, FeatureExtractionMixin, List, Literal, ORPOConfig, ORPOTrainer, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedModelWrapper, PreTrainedTokenizerBase, ProcessorMixin, Trainer, TrainerCallback, Tuple, Union, add_bos_token_if_needed, add_eos_token_if_needed, amp, deepcopy, defaultdict, disable_dropout_in_model, generate_model_card, inspect, is_peft_available, is_torch_fx_proxy, is_torch_xla_available, is_wandb_available, maybe_apply_chat_template, maybe_extract_prompt, nn, np, nullcontext, os, pad_to_length, peft_module_casting_to_bf16, prepare_model_for_kbit_training, random, textwrap, torch, warnings, AutoModelForCausalLM, BaseImageProcessor, Callable, DPODataCollatorWithPadding, DataCollator, Dataset, Dict, EvalLoopOutput, F, FeatureExtractionMixin, List, ORPOConfig, ORPOTrainer, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, ProcessorMixin, Trainer, TrainerCallback, Tuple, Union, amp, defaultdict, disable_dropout_in_model, inspect, is_peft_available, is_wandb_available, maybe_apply_chat_template, maybe_extract_prompt, nn, np, os, peft_module_casting_to_bf16, prepare_model_for_kbit_training, torch, warnings)
